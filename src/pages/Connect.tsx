...
const Connect = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
          ...
          <div className="rounded-2xl bg-neutral-900/80 border border-neutral-800 divide-y divide-neutral-800">
            {fitnessCreators.map((creator) => (
              ...
              >
                ...
                <button className="text-xs font-medium px-3 py-1.5 rounded-full bg-white text-black">
                  Follow
                </button>
              </div>
            ))}
      ...
      {/* Bottom CTA Buttons */}
      <div className="fixed left-0 right-0 bottom-0 px-5 pb-6 pt-4 bg-gradient-to-t from-black via-black/90 to-transparent">
        <button 
          onClick={() => navigate("/today")}
          className="w-full rounded-full py-3.5 text-sm font-semibold bg-[#5D5FEC] text-white"
        >
          Continue
        </button>
        <button 
